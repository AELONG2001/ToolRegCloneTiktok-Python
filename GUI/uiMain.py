...
def uiMain(self, ToolRegCloneTiktok):
    ...
    self.list_video = QPushButton(parent=self.home)
    self.list_video.setGeometry(QRect(840, 10, 121, 24))
    icon.addPixmap(
        QPixmap(".\\icons/folder-video.png"),
        QIcon.Mode.Normal,
        QIcon.State.Off,
    )
    self.list_video.setIcon(icon)
    ...
    self.table_account_info.setGeometry(QRect(10, 80, 860, 360))
    ...
    self.table_account_info.setColumnCount(7)
    ...
    item = QTableWidgetItem()
    self.table_account_info.setHorizontalHeaderItem(6, item)
    ...
    self.table_account_info.setColumnWidth(2, 300)
    ...
    self.is_upload_avatar_label.setObjectName("is_upload_avatar_label")
    self.is_upload_avatar = QCheckBox(parent=self.home)
    self.is_upload_avatar.setGeometry(QRect(100, 50, 72, 20))
    self.is_upload_avatar.setStyleSheet("font: 600 10pt \"Segoe UI\";")
    self.is_upload_avatar.setObjectName("is_upload_avatar")
    self.is_upload_avatar.setChecked(False)
    self.is_upload_video_label = QLabel(parent=self.home)
    self.is_upload_video_label.setGeometry(QRect(250, 48, 100, 20))
    self.is_upload_video_label.setStyleSheet(
        'font: 600 10pt "Segoe UI";'
    )
    self.is_upload_video_label.setObjectName("is_upload_video_label")
    self.is_upload_video = QCheckBox(parent=self.home)
    self.is_upload_video.setGeometry(QRect(230, 50, 72, 20))
    self.is_upload_video.setStyleSheet("font: 600 10pt \"Segoe UI\";")
    self.is_upload_video.setObjectName("is_upload_video")
    self.is_upload_video.setChecked(True)
    self.is_run_tds_label = QLabel(parent=self.home)
    self.is_run_tds_label.setGeometry(QRect(370, 48, 100, 20))
    self.is_run_tds_label.setStyleSheet(
        'font: 600 10pt "Segoe UI";'
    )
    self.is_run_tds_label.setObjectName("is_run_tds_label")
    self.is_run_tds = QCheckBox(parent=self.home)
    self.is_run_tds.setGeometry(QRect(350, 50, 72, 20))
    self.is_run_tds.setStyleSheet("font: 600 10pt \"Segoe UI\";")
    self.is_run_tds.setObjectName("is_run_tds")
    self.is_login_google_label = QLabel(parent=self.home)
    self.is_login_google_label.setGeometry(QRect(460, 48, 100, 20))
    self.is_login_google_label.setStyleSheet(
        'font: 600 10pt "Segoe UI";'
    )
    self.is_login_google_label.setObjectName("is_login_google_label")
    self.is_login_google = QCheckBox(parent=self.home)
    self.is_login_google.setGeometry(QRect(440, 50, 72, 20))
    self.is_login_google.setStyleSheet("font: 600 10pt \"Segoe UI\";")
    self.is_login_google.setObjectName("is_login_google")
    self.is_login_cookie_label = QLabel(parent=self.home)
    self.is_login_cookie_label.setGeometry(QRect(572, 48, 100, 20))
    self.is_login_cookie_label.setStyleSheet(
        'font: 600 10pt "Segoe UI";'
    )
    self.is_login_cookie_label.setObjectName("is_login_cookie_label")
    self.is_login_cookie = QCheckBox(parent=self.home)
    self.is_login_cookie.setGeometry(QRect(552, 50, 72, 20))
    self.is_login_cookie.setStyleSheet("font: 600 10pt \"Segoe UI\";")
    self.is_login_cookie.setObjectName("is_login_cookie")
    self.avatar_value = QLineEdit(parent=self.home)
    self.avatar_value.setGeometry(QRect(720, 10, 113, 21))
    self.avatar_value.setObjectName("avatar_value")
    self.video_value = QLineEdit(parent=self.home)
    self.video_value.setGeometry(QRect(970, 12, 140, 21))
    self.video_value.setObjectName("video_value")
    self.list_mail = QPushButton(parent=self.home)
    self.list_mail.setGeometry(QRect(340, 10, 121, 24))
    icon3 = QIcon()
    icon3.addPixmap(
    ...
    self.captcha_type = QComboBox(parent=self.setting_tool)
    self.captcha_type.setObjectName("comboBox")
    self.captcha_type.setGeometry(QRect(380, 30, 101, 21))
    self.captcha_type.addItem("")
    self.captcha_type.addItem("")
    self.captcha_type.addItem("")
    self.captcha_key = QLineEdit(parent=self.setting_tool)
    self.captcha_key.setGeometry(QRect(500, 30, 141, 20))
    self.captcha_key.setObjectName("captcha_key")
    self.database =QLabel(parent=self.setting_tool)
    self.database.setGeometry(QRect(380, 70, 60, 21))
    self.database.setObjectName("database")
    self.database_value =QLineEdit(parent=self.setting_tool)
    self.database_value.setGeometry(QRect(446, 70, 280, 21))
    self.database_value.setStyleSheet("font: 10pt \"Segoe UI\";")
    self.database_value.setObjectName("database_value")
    ...
    self.type_reg_country_label.setGeometry(QRect(780, 70, 101, 21))
    ...
    self.type_reg_country.addItem("")
    self.type_reg_country.setGeometry(QRect(886, 70, 101, 24))
    ...
    if os.path.exists("configs_account.json"):
        ...
        if "proxy_type" in data:
            if data["proxy_type"] == 4 or data["proxy_type"] == 5:
    ...
    self.is_login_google.toggled.connect(self.checkLoginGoogle)
    self.is_login_cookie.toggled.connect(self.checkLoginCookie)
    ...
    self.database_value.textChanged.connect(self.getDatabaseValue)
