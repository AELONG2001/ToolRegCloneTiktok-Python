def darkMode(self):
    ...
    self.is_upload_avatar_yes.setStyleSheet("color: #fff")
    self.is_upload_avatar_no.setStyleSheet("color: #fff")
    ...
    self.api_token_gologin_value.setStyleSheet(f"color: #fff; background-color: {background_element_dark_mode}")
    self.path_gologin_value.setStyleSheet(f"color: #fff; background-color: {background_element_dark_mode}")
    self.api_hotmailbox_value.setStyleSheet(f"color: #fff; background-color: {background_element_dark_mode}")
